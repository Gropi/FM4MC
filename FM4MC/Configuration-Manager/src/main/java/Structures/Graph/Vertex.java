...
public class Vertex implements IVertex {
    ...
    public Vertex(String label, int vertexId, String serviceName) {
        ...
        _ConditionalWeights = new ArrayList<>();
    ...
    @Override
    public List<ConditionalWeight> getConditionalWeights() {
        return _ConditionalWeights;
    }

    @Override
    public void addConditionalWeight(IVertex vertex) {
        _ConditionalWeights.add(new ConditionalWeight(vertex, -1));
    }

    @Override
    public void bindMicroservice(Microservice service){
