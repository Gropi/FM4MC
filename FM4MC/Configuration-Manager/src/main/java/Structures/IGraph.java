...
public interface IGraph {
     ...
     */
    void addEdge(int startID, int endID, int edgeCount);

    List<Edge> getEdgesBetweenVertices(IVertex outgoing, IVertex ingoing);

    List<Edge> getEdgesBetweenVertices(int outgoingVertexID, int ingoingVertexID);
